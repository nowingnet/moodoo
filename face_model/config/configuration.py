...
class Configuration:
    ...
    def set_arguments(self):
        self.parser.add_argument("--expname", type=str, 
                            help='experiment name')
        self.parser.add_argument("--basedir", type=str, default='./logs/', 
                            help='where to store ckpts and logs')
        self.parser.add_argument("--datadir", type=str, default='./data/llff/fern', 
        ...
        self.parser.add_argument("--N_rand", type=int, default=32*32*4, 
        ...
        self.parser.add_argument("--N_importance", type=int, default=0,
                            help='number of additional fine samples per ray')
        self.parser.add_argument("--perturb", type=float, default=1.,
                            help='set to 0. for no jitter, 1. for jitter')
        self.parser.add_argument("--use_viewdirs", action='store_true', 
        ...
        # dataset options
        self.parser.add_argument("--dataset_type", type=str, default='llff', 
        ...
        self.parser.add_argument("--half_res", action='store_true', 
